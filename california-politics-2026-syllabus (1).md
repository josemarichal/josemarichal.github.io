...
Class Meeting Times & Location:	Mondays, Wednesdays, and Fridays (10:30am)
...
*   [California Policy Dashboard](california_policy_dashboard.html) & [California Policy Workbook](california_advocacy_resources.html).
...
### **Week 1: The Polycrisis and the Abundance Agenda**
...
* **Required:**
  ...
  * Listen: [Adam Tooze on the Polycrisis (click on the gray listen button on the upper righthand side of the screen)](https://radioopensource.org/polycrisis/)
...
### **Week 15: Political Causes and Final Examination**
...
**Fri, Dec. 11**
* *No Class (Finals Week)* 📌 Final Examination.
...
* **Device-Free Classroom:** The use of laptops, tablets, and smartphones is generally prohibited during class. Our seminars will rely on device-free, guided discussions to afford students the freedom to think for themselves and engage in good faith, face-to-face, without the cacophony of disembodied voices. For students who prefer digital notes, we recommend taking handwritten notes and using free OCR (Optical Character Recognition) apps after class to transcribe them. Excellent free options include **[Microsoft Lens](https://support.microsoft.com/en-us/office/microsoft-lens-for-ios-fbdca5f4-1b1b-4391-a931-dc1c2582397b)**, **[Google Drive](https://support.google.com/drive/answer/176692?hl=en&co=GENIE.Platform%3DDesktop)**, or the built-in document scanner in **[Apple Notes](https://support.apple.com/en-us/HT210336)**.
